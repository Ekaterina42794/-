...
print('оценки в алфавитном порядке',type(grades),grades)
students = {'Johnny', 'Bilbo', 'Steve', 'Khendrik', 'Aaron'}
print('список студентов рандомно',type(students),students)
...
print(grades)
ср_балл={key:value for(key,value)in zip(students,grades)}
print('Средний балл_', ср_балл)
